export const softwareProjects = [
  ...
  {
    id: "2",
    name: "CellMate V2 - ReactJS",
    description:
      "Revisiting my earlier version of Fallout Cascadia CellMate, after graduating from the Flatiron program, I set out to revamp and release CellMate to the Fallout Cascadia team. With this iteration I overhauled the front end to incorporate ReactJS as well as practice with Bootstrap UI and external libraries. After working with the team to include and refine features, the app is successfully deployed and currently in use.",
  ...
  },
  {
    ...
    stack: "HTML, CSS, Sinatra, Ruby, MongoDB",
    image: "https://picsum.photos/400",
